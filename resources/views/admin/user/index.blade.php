...
<a href="{{route('user-export-pdf')}}" class="btn btn-primary waves-effect waves-light">Export PDF</a>
@endsection
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$hasil->email}}</td>
                                                <td>{{$hasil->phone}}</td>
                                                <td><center><img src="{{ $hasil->avatar == 'null' ? asset('dist/images/avatar.png') : asset('dist/images/'.$hasil->avatar.'')}}" alt="" width="50px"></center></td>
                                            </tr>
                                            @endforeach
                                            </tbody>
                                        </table>
