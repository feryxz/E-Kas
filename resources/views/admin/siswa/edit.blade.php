                ...
                <div class="card m-b-20">
                    ...
                    <form action="{{route('siswa.update', $siswa->id)}}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input disabled class="form-control" name="induk" type="text" value="{{$siswa->induk}}" id="example-text-input">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-search-input" class="col-sm-2 col-form-label">Nama </label>
                            <div class="col-sm-10">
                                <input class="form-control" name="nama" type="text" value="{{$siswa->nama}}" id="example-search-input">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="kelas">
                                    ...
                                    <option value="{{$data->id}}" @if($data->id == $siswa->kelas_id)
                                        selected
                                        @endif
                                        >{{$data->nama}}</option>
                                    @endforeach
